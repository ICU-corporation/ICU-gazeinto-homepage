...
export const translations = {
  ko: {
    ...
    card0_title: "01 / LIVE PRESCRIBED OPTIC",
    ...
    card2_title: "03 / CLINICAL MATRIX",
    card2_badge: "CLINICAL VALIDATED",
    card2_amd_label: "황반변성(AMD)",
    card2_amd_val: "정상 <1%",
    card2_glaucoma_label: "시신경(녹내장)",
    card2_glaucoma_val: "C/D 0.32",
    card2_dr_label: "망막혈관(DR)",
    card2_dr_val: "Clear",
  ...
  en: {
    // Header
    nav_dashboard: "01 Dashboard",
    nav_tech: "02 Technology",
    nav_clinical: "03 Clinical",
    nav_faq: "04 FAQ",
    ...
    card2_title: "03 / CLINICAL MATRIX",
    card2_badge: "CLINICAL VALIDATED",
    card2_amd_label: "AMD (Macular)",
    card2_amd_val: "Normal <1%",
    card2_glaucoma_label: "Optic Nerve",
    card2_glaucoma_val: "C/D 0.32",
    card2_dr_label: "Retinal Vessels",
    card2_dr_val: "Clear",
    card2_stat_acc: "Concordance Rate",
